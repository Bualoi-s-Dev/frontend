<template>
  ...
  <div class="relative inline-block" :class="{ 'opacity-50': disabled }">
    <!-- Avatar Container -->
    <div class="w-32 h-32 rounded-full shadow-lg">
      <img :src="src" :alt="altText" class="w-full h-full object-cover rounded-full" />
    </div>
    ...
    <div v-if="canEdit"
      ...
      <button :disabled="disabled" @click="changeImage"
