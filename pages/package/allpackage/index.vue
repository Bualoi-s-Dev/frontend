        ...
        <div class="flex flex-col">
            <div class="flex flex-row justify-between mx-5.5">
                <div class="flex flex-row items-center gap-3">
                    <BackButton/>
                    <h1 class="text-md">Show package</h1>
                </div>
                
            </div>
            <div class="w-full h-full py-3 px-5 flex flex-row items-center">
                <input v-model="name" type="text" class="mr-2 border border-stroke w-full rounded-md text-lg" />
                <Button icon-color="gray" bg-color="bg-white" middle-icon="basil:filter-outline" button-options="border border-stroke rounded-md"></Button>
            </div>
