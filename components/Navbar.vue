    ...
    <div class="flex items-center justify-end mr-5">
      ...
      >
        ...
        <ul class="divide-y-1 mx-3">
          <li>
            <a @click="onHome" class="my-4 inline-block text-red-300">Home</a>
          </li>
          <li>
            <a @click="onAppointment" class="my-4 inline-block">Appointments</a>
          </li>
          <li v-if="user.role == 'Photographer'">
            <a @click="onBusy" class="my-4 inline-block">My busy time</a>
          </li>
          <li v-if="user.role == 'Photographer'">
            <a @click="onCompleted" class="my-4 inline-block">History</a>
          </li>
