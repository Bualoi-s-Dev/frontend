...
// SMS validation
const isSMSValid = computed(() => smsValidate.value);

// Form validation
const isFormValid = computed(() => isEmailValid.value);
...
<template>
  ...
  <LoginRegisterCard>
      ...
      <div class="flex flex-col gap-[20px]">
        <div class="flex flex-col gap-[16px]">
          <div>
            ...
            <p class="text-sm/6">
              We sent a reset link to 653xxxxx21@student.chula.ac.th enter 5
              digit code that mentioned in the email
            </p>
            <div class="flex space-x-2 p-4">
              <div
                class="w-12 h-12 flex items-center justify-center border border-black rounded-lg text-lg font-semibold"
              >
                8
              </div>
              <div
              ...
              <div
                class="w-12 h-12 flex items-center justify-center border border-gray-300 rounded-lg text-lg text-gray-400"
              >
                &nbsp;
              </div>
              <div
    ...
    <div class="flex items-center justify-center">
      <div v-for="step in pages" :key="step" class="flex items-center">
        <div
