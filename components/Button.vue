...
<template>
  <button :disabled="disabled" :class="buttonClasses" type="button">
    ...
    <slot name="middleIcon">
      <img
        v-if="typeof props.middleIcon === 'string'"
        :src="props.middleIcon"
        :class="props.iconSize + ' mx-2'"
      />
      <component
        v-else-if="props.middleIcon"
        :is="props.middleIcon"
        :class="props.iconSize + ' mx-2'"
      />
    </slot>
    ...
    <slot name="rightIcon">
      <img
        v-if="typeof props.rightIcon === 'string'"
        :src="props.rightIcon"
        :class="props.iconSize + ' ml-2'"
      />
      <component
