...
<template>
  <button :class="buttonClasses" type="button">
    ...
    <slot name="leftIcon">
      <Icon
        v-if="!slots.leftIcon && isIconifyName(props.leftIcon)"
        :icon="props.leftIcon"
    ...
    <slot name="middleIcon">
      <Icon
        v-if="!slots.middleIcon && isIconifyName(props.middleIcon)"
    ...
    <slot name="rightIcon">
      <Icon
        v-if="!slots.rightIcon && isIconifyName(props.rightIcon)"
